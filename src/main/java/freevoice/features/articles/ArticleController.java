...
public class ArticleController extends GenericController<ArticleEntity, Long> {
    ...
    // public ResponseEntity<ArticleEntity> create (@RequestBody ArticleEntity
    // article) {
    ...
    // public ResponseEntity<ArticleEntity> getByName(@PathVariable("name") String
    // name) {
    // return new ResponseEntity<>(articleService.getByName(name), HttpStatus.OK);
    // }

    // @DeleteMapping(URLS.deleteArticle)
    // public ResponseEntity<String> delete(@RequestBody ArticleEntity
    // articleEntity) {
